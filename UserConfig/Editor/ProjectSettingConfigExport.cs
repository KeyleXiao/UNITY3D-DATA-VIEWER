...
public class ProjectSettingViewer : ConfigEditorSchema<ProjectSetting>
{
	...
	{
		ProjectSettingViewer w = UnityEngine.ScriptableObject.CreateInstance<ProjectSettingViewer>();
		w.ShowUtility();
	}
	...
	public override ProjectSetting CreateValue()
	{
		ProjectSetting r = base.CreateValue();
		return r;
	}

	public override void Initialize()
	{
		SetConfigType(new ProjectSettingConfig());
	}
}
